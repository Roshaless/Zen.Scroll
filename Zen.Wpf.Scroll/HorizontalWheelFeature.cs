...
namespace System.Windows
{
    ...
    {
        public static Func<object, object> BuildGetter(Type declaringType, string propertyName)
        {
        ...
        public static Func<object, TValue> BuildGetter<TValue>(Type declaringType, string propertyName)
        {
            // obj => (object)obj.Property
            var obj = System.Linq.Expressions.Expression.Parameter(typeof(object), "obj");
            var cast = System.Linq.Expressions.Expression.Convert(obj, declaringType);
            var access = System.Linq.Expressions.Expression.PropertyOrField(cast, propertyName);
            var boxed = System.Linq.Expressions.Expression.Convert(access, typeof(TValue));
            return System.Linq.Expressions.Expression.Lambda<Func<object, TValue>>(boxed, obj).Compile();
        }
        ...
        public static Action<object, object> BuildSetter(Type declaringType, string propertyName)
        {
            ...
            var cast = System.Linq.Expressions.Expression.Convert(obj, declaringType);
            var access = System.Linq.Expressions.Expression.PropertyOrField(cast, propertyName);
            var boxed = System.Linq.Expressions.Expression.Convert(value, access.Member is PropertyInfo info ? info.PropertyType : ((FieldInfo)access.Member).FieldType);
